...
Participants will be randomized to one of our three interview conditions. See list of participant allocation here (add link) and the code used to generate the list here (add link).
